...
<section class="content">
    ...
    <div class="container-fluid">
        <!-- Form -->
        <form method="POST" action="{{ url('/employees/edit') }}">
            @csrf
            <div class="form-group">
                <label for="nomor_induk">Nomor Induk</label>
                <input type="text" class="form-control" id="nomor_induk" name="nomor_induk" placeholder="Enter Nomor Induk" value="{{ $employee->nomor_induk }}" readonly>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Enter Alamat" value="{{ $employee->alamat }}">
            </div>
            <div class="form-group">
